...
us_matr_1 = [[4, 4, 8],[5, 9, 91],[25, 11, 69]]
us_matr_2 = [[12, 23, 34],[123, 56, 456],[65, 125, 258]]

my_matrix = Matrix(us_matr_1, us_matr_2)
...
class Textil:
    ...
    def get_sq_full(self):
        return str(f'Площадь общая ткани \n'
                   f' {(self.width / 6.5 + 0.5) + (self.height * 2 + 0.3)} М^2')
...
class Coat(Textil):
    ...
    def __str__(self):
        return f'Площадь на пальто {self.square_c} М^2'
...
class Jacket(Textil):
    ...
    def __str__(self):
        return f'Площадь на костюм {self.square_j} М^2'

coat = Coat(10, 5)
jacket = Jacket(111, 202)
print(coat)
print(jacket)

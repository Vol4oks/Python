...
class Road:
    ...
    def asphalt_mass(self):
        ...
        print(f'Для покрытия всего дорожного полотна неободимо {round(asphalt_mass)} тонны асфальта')


us_unit = Road(20, 5000, 5)
us_unit.asphalt_mass()
...
user = Position('Гарет', 'Тихонов', 'QA', '120000', '20000')
print(user.get_full_name(), user.get_total_income())
...
class TownCar(Car):
    def show_speed(self):
        ...
        if self.speed > 60:
            ...
            return f'Ваша скорость: {self.speed}. Ниже ограничения.\n'
